...
const characters = [
  {
    ...
    description: {
      ...
      fr: "Fils du tonnerre et de la royaute, choisi par le Collier de la Destinee. Zaire doit equilibrer sa vie privilegiee avec les exigences de l'appel d'un heros."
    },
    powers: [
      { icon: Zap, name: { en: "Lightning Control", fr: "Controle de la Foudre" } },
      { icon: Crown, name: { en: "Royal Authority", fr: "Autorite Royale" } },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Heritiere des reines guerrieres, chasseuse d'ombres et protectrice de l'Ethercobalt. Elle porte le pouvoir des dieux nubiens dans ses veines."
    },
    powers: [
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Genie maudit de la technologie interdite. Maitre des constructions techno-mystiques qui brouillent la frontiere entre science et magie ancienne."
    },
    powers: [
      { icon: Flame, name: { en: "Blood Technology", fr: "Technologie de Sang" } },
      { icon: Shield, name: { en: "Construct Creation", fr: "Creation de Constructs" } },
      { icon: Eye, name: { en: "Pattern Vision", fr: "Vision des Motifs" } }
    ],
    color: "#8B0000",
    kingdom: { en: "Iron Desert of Tsoro", fr: "Desert de Fer de Tsoro" }
  },
  {
    id: "jumeaux-njoko",
    name: { en: "THE NJOKO TWINS", fr: "LES JUMEAUX NJOKO" },
    title: { en: "Orphan Prophets", fr: "Prophetes Orphelins" },
    description: {
      en: "Orphan prophets who speak with rivers and stars. Their dual nature connects the physical realm to the spirit world.",
      fr: "Prophetes orphelins qui parlent avec les rivieres et les etoiles. Leur double nature connecte le royaume physique au monde des esprits."
    },
    powers: [
      { icon: Droplets, name: { en: "Water Communion", fr: "Communion Aquatique" } },
      { icon: Eye, name: { en: "Star Reading", fr: "Lecture des Etoiles" } },
  ...
  },
  {
    ...
    title: { en: "Guardian of Sky Beasts", fr: "Gardienne des Betes du Ciel" },
    description: {
      en: "Sovereign of Stormglass, guardian of the celestial creatures that patrol the boundaries between worlds.",
      fr: "Souveraine de Stormglass, gardienne des creatures celestes qui patrouillent les frontieres entre les mondes."
    },
    powers: [
      { icon: Crown, name: { en: "Sky Command", fr: "Commandement du Ciel" } },
      { icon: Shield, name: { en: "Beast Bond", fr: "Lien des Betes" } },
      { icon: Zap, name: { en: "Storm Summoning", fr: "Invocation des Tempetes" } }
    ],
    color: "#9370DB",
    kingdom: { en: "Skyfall Islands", fr: "Iles Skyfall" }
  }
]
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6" style={{ color: 'var(--isolele-accent)' }}>
              {language === 'fr' ? "LES ELUS" : "THE CHOSEN ONES"}
            </h1>
            <p className="text-xl max-w-3xl mx-auto italic" style={{ color: 'var(--isolele-text-secondary)' }}>
              {language === 'fr'
                ? "Ces ne sont pas des heros empruntes a des mythes etrangers. Ils sont nes du sol, de l'esprit et du ciel du continent mere."
